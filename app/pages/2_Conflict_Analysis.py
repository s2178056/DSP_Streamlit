...
def conflict_analysis():
    ...
    st.markdown(
        ...
        - **Edges**:
          - **Solid Red Lines**: Represent "conflict" between attributes with opposing opinions.
          - **Dotted Green Lines**: Represent "alliances" between attributes with similar opinions.
